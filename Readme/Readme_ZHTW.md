...
*   進入後，左邊有一個列表清單，最上方有一個「新增帳號」，點他就代表你要新增帳號。
...
*   「起動」的作用：可以放入執行檔或網址，未來按下起動，就會幫你打開他。
...
1.  目錄密碼以SHA256加鹽200萬次，相當於提升密碼3.5位。
...
1.  非資料雜湊隨機值，但為了降低曝露風險，只有在資料修改後才會重新加密。
...
*   Ａ：我對於手機 App 開發不熟悉、也用不到，所以不會喔。  
     
*   Ｑ：線上掃毒說有病毒？
*   Ａ：由於採取了一些普通軟體較為少用的技術去處理安全性問題，被誤判也是在所難免。不管怎樣，請於正確網址下載並檢查程式碼、自行編譯後執行是最安全可靠的。  
     
*   Ｑ：我忘記目錄密碼了怎麼辦？
