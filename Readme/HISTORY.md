#### v3.1.9739.3565 (2026/08/31)

*  升級 MAGI-Crypt V2（注意：與舊版不相容）

#### v3.0.9516.726 (2026/01/20)

1. 新的目的資料夾產生方式
2. 加密時加入前16byte隨機資料，強化整體防禦能力
3. 修正一些小bug
4. 增加Wine下執行相容能力（請使用caffe-9.7以上）
5. 部分代碼最佳化

#### v2.0.9073.1620 (2024/11/03)

1. 改良 KDF 模式，演算法加入記憶體硬化（64MB），命名為 MAGI-Crypt 演算法
